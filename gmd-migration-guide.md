...
Read [[gmd-primer#root]] first for the form-selection decision
...
rel: depends-on -> [[gmd-primer#root]]
...
2. Prefer the recommended verbs (see [[gmd-primer#root]]):
...
3. **Add a primer link.** Reference [[gmd-primer#root]] from
