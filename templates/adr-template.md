...
rel: related-to -> [[gmd-primer#root]]
...
For the full ADR extractor reference, see your project's ADR format doc.
For authoring conventions across all doc forms: [[gmd-primer#root]].
